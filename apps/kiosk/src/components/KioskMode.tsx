...
export default function KioskMode({ isActive, onToggle, kioskName, location }: KioskModeProps) {
  ...
  if (!isActive) {
    return (
      <div className="kiosk-mode-prompt">
        <button onClick={handleEnterKioskMode} className="kiosk-mode-btn">
          Enter Kiosk Mode
        </button>
      </div>
    )
    ...
    <>
      ...
      <div className="kiosk-header">
        ...
        <div className="kiosk-header-actions">
          <ConnectionStatus />
          <button onClick={handleExitRequest} className="exit-kiosk-btn" title="Exit Kiosk Mode">
            ⚙️
          </button>
        </div>
      </div>
        ...
        <div className="exit-prompt-overlay">
          <div className="exit-prompt">
            ...
            <div className="exit-prompt-actions">
              <button onClick={handleExitKioskMode} className="btn-confirm">
                Exit
              </button>
              <button onClick={() => setShowExitPrompt(false)} className="btn-cancel">
                Cancel
              </button>
            </div>
          </div>
